...
- **eDiscovery 經理**-eDiscovery 管理員可以使用 「 內容搜尋工具安全性&amp;規範中心來執行各種與搜尋相關動作，例如預覽與匯出搜尋及搜尋組織中的內容位置結果。成員也可以建立與管理 eDiscovery 案例、 新增和移除成員案例、 建立 case 保留及執行內容與案例相關聯的搜尋。EDiscovery 管理員，才能存取及管理他們所建立的案例。使用者無法存取或管理的情況下建立其他 eDiscovery 管理員。 
...
- **eDiscovery 管理員**-eDiscovery 管理員 eDiscovery 管理員角色群組的成員，且可以執行相同的內容搜尋與 eDiscovery 管理員可執行區分管理相關的工作。此外，eDiscovery 管理員可以： 
  ...
  - 設定使用者、 建立的情況下，以及匯入資料的進階 eDiscovery 中執行管理工作。這是因為 eDiscovery 安全性的系統管理員的人員&amp;規範中心會自動新增為進階 eDiscovery 的管理員。
...
在 [安全性]**權限**] 頁面上&amp;規範中心，您也可以指派使用者 eDiscovery 相關的權限透過將它們新增至 [規範管理員、 組織管理及檢閱者 」 角色群組。如需 eDiscovery 相關的角色指派給每個這些角色群組的清單，請參閱 ＜[的詳細資訊](#more-information)] 區段中。 
  
## <a name="more-information"></a>其他資訊

- **什麼是 eDiscovery 相關的角色安全性&amp;規範中心？** 下表說明 eDiscovery 相關的角色安全性&amp;規範中心並指出每個角色指派給、 預設的內建角色群組。 
    
|**角色**|**規範系統管理員**|**eDiscovery 管理員&amp;管理員**|**組織管理**|**檢閱者**|
|:-----|:-----|:-----|:-----|:-----|
|**管理 （英文）** <br/> 可讓使用者建立、 編輯、 刪除及控制存取安全性的 eDiscovery 案例&amp;規範中心。如需詳細資訊，請參閱[管理 Office 365 安全性的 eDiscovery 案例&amp;規範中心](manage-ediscovery-cases.md)。<br/> 如先前所述，使用者必須具有案例管理角色才可以使用**Add eDiscoveryCaseAdmin**指令程式，使其 eDiscovery 管理員。  <br/> |![核取記號](media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)           <br/> |![核取記號](media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)           <br/> |![核取記號](media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)           <br/> | <br/> |
|**合規性搜尋** <br/> 可讓使用者執行內容搜尋工具安全性&amp;規範中心來搜尋信箱與公用資料夾、 SharePoint Online 網站、 OneDrive for Business 的網站、 Skype for Business 交談、 Office 365 群組及 Microsoft 小組。此角色可讓使用者取得搜尋結果的評估並建立匯出報告，但其他角色不需要修改初始化內容搜尋動作，例如預覽、 匯出或刪除搜尋結果。<br/><br/>請注意使用者指派規範搜尋角色但不需要預覽角色可預覽其預覽巨集指令具有起始由使用者指派角色預覽搜尋結果。沒有預覽角色的使用者可以預覽最多 2 週的初始預覽巨集指令建立後的結果。<br/><br/> 同樣地，指派給使用者的規範搜尋角色，但沒有角色可以下載中的匯出巨集指令具有由已指派 「 匯出 」 角色的使用者起始的搜尋結果匯出。沒有匯出角色的使用者可以下載最多 2 週後的初始匯出巨集指令建立的搜尋結果。之後，他們將無法除非某人匯出角色與重新啟動匯出下載結果。<br/><br/>如需詳細資訊，請參閱[Office 365 中的內容搜尋](content-search.md)。  <br/> |![核取記號](media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)           <br/> |![核取記號](media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)           <br/> |![核取記號](media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)           <br/> | <br/> |
|**匯出** <br/> 讓使用者可以將內容的搜尋結果匯出至本機電腦。它也可讓其準備分析進階在 eDiscovery 中搜尋結果。<br/> 如需匯出搜尋結果的詳細資訊，請參閱[匯出搜尋結果的 Office 365 安全性&amp;規範中心](export-search-results.md)。  <br/> | <br/> |![核取記號](media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)           <br/> | <br/> | <br/> |
|**保留** <br/>  讓使用者可以將內容放入信箱、 公用資料夾、 網站、 Skype 商務交談和音樂的 Office 365 群組。保留內容時，內容擁有者將仍能修改或刪除原始的內容，但會保留內容，直到撤除或保留期間到期。<br/>  如需保留的詳細資訊，請參閱：  <br/> [管理 Office 365 安全性的 eDiscovery 案例&amp;規範中心](manage-ediscovery-cases.md) <br/> [保留原則概觀](retention-policies.md) <br/> |![核取記號](media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)           <br/> |![核取記號](media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)           <br/> |![核取記號](media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)           <br/> | <br/> |
|**預覽** <br/> 可讓使用者檢視內容的搜尋所傳回的項目清單。他們也必須能夠開啟並檢視來檢視其內容清單中的每個項目。<br/> | <br/> |![核取記號](media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)           <br/> | <br/> | <br/> |
|**檢閱** <br/> 可讓使用者看到和在 [安全性] 中開啟 [eDiscovery] 頁面上的案例清單&amp;他們是成員的規範中心。他們無法執行任何其他管理工作。<br/> | <br/> |![核取記號](media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)           <br/> | <br/> |![核取記號](media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)           <br/> |
|**RMS 解密** <br/> 讓使用者可以匯出進階在 eDiscovery 中搜尋結果或準備進行分析的搜尋結果時解密 RMS 加密電子郵件。如需在匯出期間解密搜尋結果的詳細資訊，請參閱[匯出搜尋結果的 Office 365 安全性&amp;規範中心](export-search-results.md)。<br/> ||![核取記號](media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)           <br/> |||
|**搜尋和清除** <br/> 可讓使用者執行大量移除相符的內容的搜尋準則的資料。如需詳細資訊，請參閱[Search for 和 Office 365 組織中的刪除電子郵件訊息](search-for-and-delete-messages-in-your-organization.md)。<br/> | <br/> | <br/> |![核取記號](media/f3b4c351-17d9-42d9-8540-e48e01779b31.png)           <br/> | <br/> |
