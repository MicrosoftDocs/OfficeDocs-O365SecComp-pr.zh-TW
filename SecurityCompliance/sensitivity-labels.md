...
- [設定 Microsoft Defender 進階威脅防護 (Microsoft Defender ATP)](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/get-started)，這會掃描標籤內容，並套用對應的 WIP 保護。 ATP 執行某些獨立於 WIP 的動作，例如報告異常狀況。
