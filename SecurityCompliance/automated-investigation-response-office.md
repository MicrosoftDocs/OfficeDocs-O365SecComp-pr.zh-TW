...
- **階段 1 (年 4 月 2019)**: Playbooks 包含建議的安全性管理員檢閱和核准的動作。 階段 1 將會包含下列 playbooks:
    - 使用者報告的釣魚程式訊息
    - URL 按一下 verdict 變更 
...
- **階段 2 （2019年的第二個半）**： 幾個新 playbooks 和 playbook 改良，加上的選項來設定安全性 playbooks 安全性管理員才會自動沒有系統管理互動的某些動作。 
