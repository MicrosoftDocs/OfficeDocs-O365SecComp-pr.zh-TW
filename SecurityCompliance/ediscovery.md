...
電子搜索 (eDiscovery) 是識別與傳遞電子資訊的程序，而且此類資訊可在法律案件中做為呈堂證據。 您可以使用 Office 365 中的 eDiscovery 搜尋的內容在 Exchange Online 信箱，Office 365 群組、 Microsoft Teams、 SharePoint Online 和 OneDrive for Business 網站與 Skype for Business 交談。 您可以在相同的 eDiscovery 搜尋中搜尋信箱和站台，藉由使用安全性 & 合規性中心中的 「 內容搜尋 」 工具。 您可以使用 eDiscovery 案例中安全性 & 合規性中心來識別、 保留、 和匯出信箱和網站中找到的內容。 如果您的組織有 Office 365 E5 訂閱，您可以進一步分析內容，藉由使用 Office 365 進階電子文件探索。
  
Office 365 提供下列的 eDiscovery 工具：
  
- [在安全性 & 合規性中心中的內容搜尋](ediscovery.md#contentsearch)
    
- [安全性 & 合規性中心中的 eDiscovery 案例](ediscovery.md#ediscoverycases)
...
|**主題**|**描述**|
|:-----|:-----|
|[在安全性 & 合規性中心執行內容搜尋](run-a-content-search-in-the-security-and-compliance-center.md) <br/> |了解如何使用內容搜尋工具來搜尋信箱、 公用資料夾，Office 365 群組、 Microsoft Teams、 SharePoint Online 網站，One Drive for Business 的位置，與 Skype for Business 交談中 Office 365 組織在單一搜尋中。  <br/> |
...
|[大量編輯內容搜尋中安全性 & 合規性中心](bulk-edit-content-searches.md) <br/> |搜尋查詢與一或多個內容搜尋的內容位置，請了解如何大量編輯。  <br/> |
...
|[使用內容搜尋來搜尋信箱與商務用 OneDrive 網站的使用者清單](search-the-mailbox-and-onedrive-for-business-for-a-list-of-users.md) <br/> |了解如何使用指令碼來搜尋信箱和一個 for Business 網站的一群使用者的磁碟機。 使用[步驟 2： 產生使用者的清單](search-the-mailbox-and-onedrive-for-business-for-a-list-of-users.md#step2)本主題，以快速產生的電子郵件地址，當您建立，並在步驟 3 中執行搜尋，您可以使用來源內容位置的清單中。  <br/> |
...
下表包含可協助您使用 eDiscovery 案例安全性 & 合規性中心中的主題連結。 使用情況下新增小組成員，可以存取這種情況，保留內容的位置與案件相關、 多個內容搜尋關聯的案例，以及從案例中匯出搜尋結果。
  
|**主題**|**描述**|
|:-----|:-----|
|[管理安全性 & 合規性中心中的 eDiscovery 案例](manage-ediscovery-cases.md) <br/> |了解如何建立及管理安全性 & 合規性中心中的 eDiscovery 案例。  <br/> |
|[指派 eDiscovery 權限中 Office?? 嗎？365 安全性 & 合規性中心](assign-ediscovery-permissions.md) <br/> |了解如何指派安全性 & 合規性中心中的 eDiscovery 權限。 您可以指派權限可讓使用者建立 eDiscovery 案例、 建立保留 eDiscovery 案例相關聯、 執行內容搜尋、 預覽搜尋結果，以及匯出搜尋結果。  <br/> |
...
|[使用指令碼將使用者新增至 eDiscovery 案例中安全性 & 合規性中心中的保留](use-a-script-to-add-users-to-a-hold-in-ediscovery.md) <br/> |了解如何使用本文中的 Windows PowerShell 指令碼，可快速將新增的信箱和 OneDrive for Business 網站的使用者清單至新的保留與安全性 & 合規性中心中的 eDiscovery 案例相關聯。  <br/> |
...
|**主題**|**描述**|
|:-----|:-----|
|[Office 365 進階電子文件探索](office-365-advanced-ediscovery.md) <br/> |了解如何進階電子文件探索工具可協助您分析 Office 365 中的資料、 簡化文件檢閱，以及做出決策有效率 ediscovery （英文）。  <br/> |
|[快速設定進階電子文件](quick-setup-for-advanced-ediscovery.md) <br/> |了解如何開始使用進階電子文件。  <br/> |
|[準備 Office 365 進階 eDiscovery 的搜尋結果](prepare-search-results-for-advanced-ediscovery.md) <br/> |了解準備進階 eDiscovery 中分析的內容搜尋的結果。  <br/> |
|[設定使用者和 Office 365 進階電子文件探索中的案例](set-up-users-and-cases-in-advanced-ediscovery.md) <br/> |了解如何設定使用者角色、 建立的情況下，並將使用者指派給進階電子文件中的案例。  <br/> |
|[執行處理序模組及載入資料](run-the-process-module-and-load-data-in-advanced-ediscovery.md) <br/> |了解準備適用於進階電子文件探索分析案例檔案的指導方針。  <br/> |
|[在 Office 365 進階電子文件探索中使用快速分析](use-express-analysis-in-advanced-ediscovery.md) <br/> |了解如何執行快速分析案例，並將結果匯出至進階電子文件的快速分析模式。  <br/> |
|[使用進階電子文件探索分析案例資料](analyze-case-data-with-advanced-ediscovery.md) <br/> |取得可讓您設定參數，執行選項，並檢視結果進階 eDiscovery 中分析處理程序的概觀。  <br/> |
|[管理進階電子文件相關性設定](manage-relevance-setup-in-advanced-ediscovery.md) <br/> |讀取設定若要依其相關性評分檔案，並產生分析結果進階電子文件中的相關性訓練的建議。  <br/> |
|[使用進階電子文件相關性模組](use-relevance-in-advanced-ediscovery.md) <br/> |了解進階電子文件，包括工作流程和指導方針和訓練和檔案檢閱步驟中的相關性模組。  <br/> |
|[使用進階電子文件的匯出案例資料](export-case-data-in-advanced-ediscovery.md) <br/> |了解匯出 eDiscovery 案例資料及進行外部檢閱結果的準則。  <br/> |
|[匯出 eDiscovery 搜尋結果從 Office 365 時，增加的下載速度](increase-download-speeds-when-exporting-ediscovery-results.md) <br/> |了解如何設定 Windows 登錄，以從進階電子文件探索中匯出案例資料時，增加的下載速度。  <br/> |
