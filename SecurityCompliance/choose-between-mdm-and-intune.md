...
|管理裝置的方式  <br/> |管理裝置使用[Office 365 安全性&amp;規範中心](https://security.microsoft.com)Office 365。  <br/> |如果您使用 Intune 本身，管理裝置使用 Intune 系統管理主控台。  <br/> 如果您使用 System Center 2012 Configuration Manager 整合 Intune，您會使用 Configuration Manager console 來管理裝置內部部署與雲端中。  <br/> |
