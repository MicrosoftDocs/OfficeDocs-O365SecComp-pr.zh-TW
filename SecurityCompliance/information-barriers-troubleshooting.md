...
在此情況下, 雖然已定義、使用中及套用資訊屏障, 但是應該防止相互通訊的人員在 Microsoft 小組中有任何不同的功能。
...
- 使用者無法在 Microsoft 小組中找到另一位使用者。
- 使用者無法在 Microsoft 小組中選取另一位使用者。
- 使用者可以看到另一位使用者, 但無法選取或傳送郵件給 Microsoft 小組中的其他使用者。
- 使用者可以查看並選取其他使用者, 但無法與 Microsoft 小組中的使用者通訊。
