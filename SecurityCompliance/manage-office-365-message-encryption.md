...
### <a name="to-manage-whether-or-not-one-time-pass-codes-are-generated-for-ome"></a>若要管理一次性複雜的程式碼產生的 OME
...
如果您選擇不要允許解密電子郵件附件，這是預設值，使用者會收到訊息表示它們不需要檢視附件的權限。
...
### <a name="to-manage-whether-or-not-email-attachments-are-decrypted-on-download-from-a-web-browser"></a>若要管理電子郵件附件進行解密上從網頁瀏覽器的下載 （英文）
...
### <a name="to-disable-the-new-capabilities-for-ome"></a>針對 OME 停用的新功能
